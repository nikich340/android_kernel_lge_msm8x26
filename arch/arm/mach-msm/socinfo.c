...
const char *hw_platform_lge[] = {
	[HW_PLATFORM_LGPS14 - HW_PLATFORM_LGE_START] 	= "LGPS14",
        ...
        [HW_PLATFORM_LG_T8WIFI - HW_PLATFORM_LGE_START]   = "T8WIFI",
};
#endif
...
static int socinfo_get_pvs(void)
{
	...
	//PVS_APC[4:0] of MSM8x26 is LSB[10:6] of QFPROM_PTE_EFUSE_ADDR
	if ((cpu_of_id[socinfo_get_id()].generic_soc_type) == MSM_CPU_8226) {
		pvs = ((pte_efuse >> 6) & 0x1F);
		return pvs;
	}
