...
static struct gpiomux_setting synaptics_ts_int_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting synaptics_ts_ldo_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting synaptics_ts_ldo_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting mms100s_ts_makerid_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting mms100s_ts_makerid_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config synaptics_ts_configs[] __initdata = {
	{
		.gpio = 0,    /*TOUCH RESET*/
		.settings = {
	...
	},
	{
		.gpio = 1,	/*TOUCH INT*/
		.settings = {
			[GPIOMUX_ACTIVE] = &synaptics_ts_int_act_cfg,
			[GPIOMUX_SUSPENDED] = &synaptics_ts_int_sus_cfg,
		},
	},
	{
		.gpio      = 76,	/* GPIO MAKER ID */
		.settings = {
			[GPIOMUX_ACTIVE]    = &synaptics_ts_makerid_act_cfg,
			[GPIOMUX_SUSPENDED] = &synaptics_ts_makerid_sus_cfg,
		},
	},
	{
		.gpio      = 77,	/* GPIO MAKER ID 2 */
		.settings = {
			[GPIOMUX_ACTIVE]    = &synaptics_ts_makerid_act_cfg,
			[GPIOMUX_SUSPENDED] = &synaptics_ts_makerid_sus_cfg,
		},
	},
	{
		.gpio      = 82,
		.settings = {
			[GPIOMUX_ACTIVE]    = &synaptics_ts_ldo_act_cfg,
			[GPIOMUX_SUSPENDED] = &synaptics_ts_ldo_sus_cfg,
		},
	},
};

static struct msm_gpiomux_config synaptics_ts_configs_rev_c[] __initdata = {
	{
		.gpio = 0,    /*TOUCH RESET*/
		.settings = {
			[GPIOMUX_ACTIVE] = &synaptics_reset_cfg,
...
static struct msm_gpiomux_config mms100s_ts_configs[] __initdata = {
	...
	},
	{
		.gpio      = 76,	/* GPIO MAKER ID */
		.settings = {
			[GPIOMUX_ACTIVE]    = &mms100s_ts_makerid_act_cfg,
			[GPIOMUX_SUSPENDED] = &mms100s_ts_makerid_sus_cfg,
		},
	},
	{
		.gpio      = 62,	/* GPIO LDO */
...
void __init msm8610_init_gpiomux(void)
{
	...
	if(revision == HW_REV_B)  /*for Synaptics S2202 Touch IC */
	{
		printk(KERN_INFO"[%s][TOUCH] HW_Revision = %d , use Synaptics, GPIO LDO", __func__, revision );
		msm_gpiomux_install(synaptics_ts_configs, ARRAY_SIZE(synaptics_ts_configs));
	}
	else if(revision >= HW_REV_C)  /*for Synaptics S2202 Touch IC */
	{
		printk(KERN_INFO"[%s][TOUCH] HW_Revision = %d , use Synaptics, Regulator ", __func__, revision );
		msm_gpiomux_install(synaptics_ts_configs_rev_c, ARRAY_SIZE(synaptics_ts_configs_rev_c));
	}
	else { /*for Melfas Touch IC : Rev.A*/
	...
	if((revision == HW_REV_A) || (revision == HW_REV_B)){
		...
		printk(KERN_ERR " [Camera] HW_REV_C is using power source from PM.\n");
	}
	else {
		msm_gpiomux_install(msm_sensor_configs_rev_c, ARRAY_SIZE(msm_sensor_configs_rev_c));
