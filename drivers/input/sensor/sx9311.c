		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL0_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL1_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL2_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL3_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL4_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL5_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL6_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL7_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL8_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL9_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL10_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL11_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL12_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL13_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL14_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL15_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL16_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL17_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL18_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_CTRL19_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_SAR_CTRL0_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_SAR_CTRL1_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_CPS_SAR_CTRL2_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_IRQ_ENABLE_REG, &reg_value);
		...
		struct device_attribute *attr, char *buf)
{
	...
	read_register(this, SX9311_IRQFUNC_REG, &reg_value);
...
static void Irq_Process_Close_Far(struct sx86XX *this)
{
	...
	if (this && (pDevice = this->pDevice)) {
		...
		read_register(this, SX9311_TCHCMPSTAT_REG, &regstat);
