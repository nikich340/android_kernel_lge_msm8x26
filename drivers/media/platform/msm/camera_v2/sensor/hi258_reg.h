...
static struct msm_camera_i2c_reg_conf hi258_recommend_settings[2][865] = {
	//60Hz
	{
		{0x03, 0x00},
		{0x01, 0x09}, //sleep on
		...
		{0x91, 0x34},
		{0x99, 0x28}, //don't touch register_SCH_150226 //14},
		{0x9c, 0x14}, //don't touch register_SCH_150226 //20131107 Flat DPC value 0x14 -> 0x00 -> 0x0a
		{0x9d, 0x15},
		{0x9e, 0x28},
		{0x9f, 0x28},
		...
		//CW//
		{0x22, 0x64},//70},//75},///6d},//6c},//6a},//38}, //LSC R 1b->15 20130125
		...
		{0x84, 0x1f},//21},//25},//22},//16}, //awb_r_gain_min normal
		{0x85, 0x3a},//3a},//3c},//42},//4f}, //awb_b_gain_max normal
...
static struct msm_camera_i2c_reg_conf hi258_preview_settings[2][85] = {
	//60Hz
	{
		{0x03, 0x00},
		{0x01, 0x09}, //Sleep On
...
static struct msm_camera_i2c_reg_conf hi258_capture_settings[2][42] = {
	//60Hz
	{
		{0x03, 0x00},
		{0x01, 0x09}, //Sleep On
...
static struct msm_camera_i2c_reg_conf hi258_HDvideo_settings[2][867] = {
	//60Hz
	{
		{0x03, 0x00},
		{0x01, 0x09}, //sleep on
		...
		{0x92, 0x28},
		{0x93, 0x02},
		{0x9c, 0x05}, //EXP Limit 2940.00 fps
		{0x9d, 0xbe},
		{0x9e, 0x00}, //EXP Unit
		{0x9f, 0xd2},
		{0xa3, 0x00}, //Outdoor Int
...
static struct msm_camera_i2c_reg_conf hi258_video_settings[2][867] = {
	//60Hz
	{
		{0x03, 0x00},
		{0x01, 0x09}, //sleep on
		...
		{0x03, 0x00}, //page 0
		{0x10, 0x91}, //Sub1/2+Bin
		{0x11, 0x94}, //Windowing On + 1Frame Skip
		{0xd2, 0x05}, //Full&Pre2 0x01, Sub&Pre1 0x05
		{0x12, 0x04}, //Rinsing edge 0x04 // Falling edge 0x00
		{0x14, 0x05},
		...
		{0x86, 0x01}, //EXPMin 12500.00 fps
		{0x87, 0xe0},
		{0x88, 0x03}, //EXP Max 60hz 24.00 fps
		{0x89, 0xcf},
		{0x8a, 0x00},
		{0xa5, 0x03}, //EXP Max 50hz 25.00 fps
		{0xa6, 0xa9},
		{0xa7, 0x80},
		{0x8B, 0xea}, //EXP100
		{0x8C, 0x60},
